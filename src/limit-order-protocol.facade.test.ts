...
import {LimitOrder, LimitOrderProtocolMethods} from "./model/limit-order-protocol.model";
...
describe('LimitOrderProtocolFacade - facade for Limit order protocol contract', () => {
    ...
    it('checkPredicate() when order predicates are valid then return true', async () => {
        ...
        const timestampBelow = limitOrderProtocolFacade.timestampBelow(timestamp); // valid value

import { ChainId, LimitOrder, LimitOrderData, LimitOrderHash, LimitOrderProtocolMethods, LimitOrderSignature, RFQOrder, RFQOrderData } from './model/limit-order-protocol.model';
...
export declare class LimitOrderBuilder {
    ...
    buildLimitOrder({ makerAssetAddress, takerAssetAddress, makerAddress, receiver, takerAddress, makerAmount, takerAmount, predicate, permit, getMakingAmount, getTakingAmount, preInteraction, // ???
    postInteraction, // ???
    salt, }: LimitOrderData): LimitOrder;

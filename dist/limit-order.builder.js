...
class LimitOrderBuilder {
    ...
    salt = this.generateSalt(), }) {
        ...
        getMakingAmount = getMakingAmount !== null && getMakingAmount !== void 0 ? getMakingAmount : this.getAmountData(limit_order_protocol_model_1.LimitOrderProtocolMethods.getMakingAmount, makerAmount, takerAmount);
        getTakingAmount = getTakingAmount !== null && getTakingAmount !== void 0 ? getTakingAmount : this.getAmountData(limit_order_protocol_model_1.LimitOrderProtocolMethods.getTakingAmount, makerAmount, takerAmount);
        ...
        const offsets = limit_order_utils_1.getOffsets(allInteractions, 1);
        return {
            salt,
            makerAsset: makerAssetAddress,
            takerAsset: takerAssetAddress,

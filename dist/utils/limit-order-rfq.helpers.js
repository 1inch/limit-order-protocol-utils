...
function createOrderOperation(isRunningWithArgv, params) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        console.log(
            kleur_1.default.white().underline(JSON.stringify(newOrder, null, 4))
        );
    });
}
...
function fillOrderOperation(isRunningWithArgv, params) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const fillingParams =
            params ||
            (yield prompts_1.default(limit_order_rfq_const_1.fillOrderSchema));
        const orderForFill = JSON.parse(fillingParams.order);
        console.log(kleur_1.default.green().bold('Order for filling: '));
        console.log(
            kleur_1.default
                .white()
                .underline(JSON.stringify(orderForFill, null, 4))
        );
        ...
        console.log(
            kleur_1.default.green().bold('Order filling transaction: ')
        );
...
function cancelOrderOperation(isRunningWithArgv, params) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        console.log(
            kleur_1.default.green().bold('Order canceling transaction: ')
        );
...
function createOrder(params) {
    const contractAddress =
        limit_order_rfq_const_1.contractAddresses[params.chainId];
    const web3 = new web3_1.default(
        limit_order_rfq_const_1.rpcUrls[params.chainId]
    );
    const providerConnector = new private_key_provider_connector_1.PrivateKeyProviderConnector(
        params.privateKey,
        web3
    );
    ...
    const limitOrderBuilder = new limit_order_builder_1.LimitOrderBuilder(
        contractAddress,
        params.chainId,
        providerConnector
    );
...
function fillOrder(params, order) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const limitOrderProtocolFacade = new limit_order_protocol_facade_1.LimitOrderProtocolFacade(
            contractAddress,
            providerConnector
        );
        ...
        const signature = yield limitOrderBuilder.buildOrderSignature(
            walletAddress,
            typedData
        );
...
function cancelOrder(params) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const contractAddress =
            limit_order_rfq_const_1.contractAddresses[params.chainId];
        const web3 = new web3_1.default(
            new web3_1.default.providers.HttpProvider(
                limit_order_rfq_const_1.rpcUrls[params.chainId]
            )
        );
        const providerConnector = new private_key_provider_connector_1.PrivateKeyProviderConnector(
...
function sendSignedTransaction(web3, txConfig, privateKey) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const sign = yield web3.eth.accounts.signTransaction(
            txConfig,
            privateKey
        );

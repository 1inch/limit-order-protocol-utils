...
const commonProperties = [
    {
        ...
        choices: [
            {
                title: 'Ethereum',
                value: limit_order_protocol_model_1.ChainId.etherumMainnet,
            },
            {
                title: 'BSC',
                value: limit_order_protocol_model_1.ChainId.binanceMainnet,
            },
            {
                title: 'Polygon',
                value: limit_order_protocol_model_1.ChainId.polygonMainnet,
            },
            {
                title: 'Optimism',
                value: limit_order_protocol_model_1.ChainId.optimismMainnet,
            },
            {
                title: 'Arbitrum',
                value: limit_order_protocol_model_1.ChainId.arbitrumMainnet,
            },
        ],
    },
    {
...
exports.rpcUrls = {
    [limit_order_protocol_model_1.ChainId.etherumMainnet]:
        'https://web3-node.1inch.io',
    [limit_order_protocol_model_1.ChainId.binanceMainnet]:
        'https://bsc-dataseed.binance.org',
    [limit_order_protocol_model_1.ChainId.polygonMainnet]:
        'https://bor-nodes.1inch.io',
    [limit_order_protocol_model_1.ChainId.optimismMainnet]:
        'https://optimism-nodes.1inch.io',
    [limit_order_protocol_model_1.ChainId.arbitrumMainnet]:

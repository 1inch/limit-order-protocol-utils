...
(() =>
    tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const operationResult = yield prompts_1.default(
            limit_order_rfq_const_1.operationSchema
        );
        switch (operationResult.operation) {
            case 'create':
                yield limit_order_rfq_helpers_1.createOrderOperation(
                    isRunningWithArgv
                );
                break;
            case 'fill':
                yield limit_order_rfq_helpers_1.fillOrderOperation(
                    isRunningWithArgv
                );
                break;
            case 'cancel':
                yield limit_order_rfq_helpers_1.cancelOrderOperation(
                    isRunningWithArgv
                );
                break;
            default:
